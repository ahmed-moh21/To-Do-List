...
import { additem } from "../rtk/ListFormSlice";
import { useDispatch } from "react-redux";

function Listform() {
  const [firstname, setfirstname] = useState("");
  const [lasetname, setlasetname] = useState("");
  ...
  const handelsubmit = (e) => {
    ...
    if (firstname) {
      dispatch(
        additem({
          onename: firstname,
          secondname: lasetname,
          numberpho: phonenumber,
          mseeage: message,
        })
      );
      alert(" Success Alert To Save Note");
    } else {
        ...
        <div className="fo-rm">
          ...
          <div>
            ...
            <input
              ...
              required
              value={lasetname}
              onChange={(e) => setlasetname(e.target.value)}
            />
          </div>
          ...
          >
            <svg
              className="w-6 h-6 text-white dark:text-white mr-3"
              aria-hidden="true"
